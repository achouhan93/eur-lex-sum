...
# Re-use existing code fragments from the related scraper
from eurlex_sum_extractor_legalacts_by_year import (
    celex_main, get_document_information, elastic_search_mapping,
    elastic_search_create, elastic_search_existing_check
)
